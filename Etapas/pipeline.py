...
Fase_7.compare_random_pixel(left_gray, right_gray) # Compara las distintas funciones de coste(SAD, SSD y NCC) en un pixel aleatorio
Fase_7.save_point_cloud(f"Etapa7/output/BM_python.ply", disparity, colors) # Guarda la nube de puntos en un archivo PLY
...
Fase_7.render("Etapa7/output/BM_python.ply")'''